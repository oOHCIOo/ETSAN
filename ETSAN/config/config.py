...
DATASET = '/home/qc/qc/All_codes/vsumm/utils/hmdb_dataset_test.h5'
SPLIT = '/home/qc/qc/All_codes/vsumm/datasets_hmdb/splits_hmdb.json' # path to split file (required)
SPLIT_ID = 0 # split index (default: 0)
METRIC = 'hdmb' # evaluation metric ['tvsum', 'summe'])
