...
class Generate_Dataset:
    def __init__(self, video_path, save_path):
        ...
        self.video_list = []
        self.video_path = ''
        self.frame_root_path = '/home/qc/qc/Data/hmdb_vsumm_frames'
    ...
    def _get_change_points(self, video_feat, n_frame, fps):
        """
        video_feat: features of the whole videos.
        n_frame: the number of frames in the whole video.
        fps: the rate of transferring video to frames.
        """
        n = n_frame / fps
    ...
    def generate_dataset(self):
        for video_idx, video_filename in enumerate(tqdm(self.video_list)):
            ...
            self.h5_file['video_{}'.format(video_idx+1)]['features_choose'] = list(video_feat_for_train)
            ...
            self.h5_file['video_{}'.format(video_idx+1)]['video_name'] = str(video_basename)

if __name__ == "__main__":
    gen = Generate_Dataset('/home/qc/qc/Data/hmdb_videos',
                           'hmdb_dataset_test.h5')
